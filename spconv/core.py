...
from cumm.conv.main import gen_gemm_params as gen_conv_params, ConvFwdAndBwdInput, ConvBwdWeight, ConvIterAlgo, GemmAlgo, ConvSingleGroupedMode
...
############################################# DEPTHWISE Optim #####################################
    ...
    *gen_conv_params(ConvFwdAndBwdInput, (64, 32, 32), (8, 32, 32),
                     NDIM_DONT_CARE,
                     ConvIterAlgo.Optimized,
                     2,
                     ["f16,f16,f16,f32,f32", "f32,f32,f32,f32,f32"],
    ...
    *gen_conv_params(ConvFwdAndBwdInput, (32, 32, 32), (8, 32, 32),
                     NDIM_DONT_CARE,
                     ConvIterAlgo.Optimized,
                     2,
                     ["f16,f16,f16,f32,f32", "f32,f32,f32,f32,f32"],
...
#############################################  SIMT  ########################################
    ...
    *gen_conv_params(ConvFwdAndBwdInput, (64, 32, 16), (32, 32, 16),
                     NDIM_DONT_CARE,
                     ConvIterAlgo.Optimized,
                     2,
                     ["f32,f32,f32,f32,f32", "f16,f16,f16,f32,f32"],
    ...
    *gen_conv_params(ConvFwdAndBwdInput, (128, 32, 16), (32, 32, 16),
                     NDIM_DONT_CARE,
                     ConvIterAlgo.Optimized,
                     2,
                     ["f32,f32,f32,f32,f32", "f16,f16,f16,f32,f32"],
    ...
    *gen_conv_params(ConvBwdWeight, (32, 32, 8), (32, 32, 8),
                     NDIM_DONT_CARE,
                     ConvIterAlgo.Optimized,
                     2,
                     ["f32,f32,f32,f32,f32", "f16,f16,f16,f32,f32"],
    ...
    *gen_conv_params(ConvBwdWeight, (32, 32, 64), (32, 32, 64),
                     NDIM_DONT_CARE,
                     ConvIterAlgo.Optimized,
                     2,
                     ["f32,f32,f32,f32,f32", "f16,f16,f16,f32,f32"],
    ...
    *gen_conv_params(ConvBwdWeight, (32, 32, 16), (32, 32, 16),
                     NDIM_DONT_CARE,
                     ConvIterAlgo.Optimized,
                     2,
                     ["f32,f32,f32,f32,f32", "f16,f16,f16,f32,f32"],
    ...
    *gen_conv_params(ConvBwdWeight, (64, 64, 32), (64, 64, 32),
                     NDIM_DONT_CARE,
                     ConvIterAlgo.Optimized,
                     2,
                     ["f32,f32,f32,f32,f32", "f16,f16,f16,f32,f32"],
...
############################################# TURING ########################################
    *gen_conv_params(ConvFwdAndBwdInput, (64, 64, 32), (32, 32, 32),
                     ...
                     ConvIterAlgo.Optimized,
                     2,
                     ["f16,f16,f16,f16,f16", "f16,f16,f16,f32,f32"],
                     NHWC,
                     NHWC,
                     NHWC,
                     GemmAlgo.Turing,
...
ALL_IMPGEMM_PARAMS = IMPLGEMM_SIMT_PARAMS + IMPLGEMM_TURING_PARAMS + IMPLGEMM_VOLTA_PARAMS + IMPLGEMM_AMPERE_PARAMS + IMPLGEMM_GROUPED_PARAMS
